...
export default function PricingSection() {
  return (
    <div className="h-[180px] w-full bg-black flex items-center justify-center">
      <div
        className="relative rounded-xl border border-white/10 p-2 flex items-center w-full"
        style={{
